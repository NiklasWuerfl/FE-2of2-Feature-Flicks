...
import {Button, Container, Table} from "react-bootstrap/esm/";
import { useParams, Link } from "react-router-dom";
import { useStates } from "./utilities/states";
import {generateBookingNumber} from "./utilities/generateBookingNumber"
...
export default function SeatSelection() {
  ...
  return s.seats.length === 0 ? null : (
    <div className="screening-and-seats bg-light text-black pt-3">
      ...
      />
      <Table className="mx-auto" style={{maxWidth: "60%"}}>
        <tbody>
        <tr>
          <th>When?</th>
